...
from agents.acommodation_assistant import get_acommodation_runnable
...
def create_accomodation_subgraph(builder):
    ...
    builder.add_node("accomodation_assistant", Assistant(get_acommodation_runnable()))
    builder.add_edge("enter_accomodation_assistant", "accomodation_assistant")
    builder.add_node(
        "accomodation_assistant_tools",
        create_tool_node_with_fallback([get_acommodation_data]),
    )
